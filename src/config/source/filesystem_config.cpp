...
static const std::string SYSTEM_INFO_GROUP = "system_info";
static const std::string SEGMENT_NUMBER_FIELD = "segment_number";
...
FilesystemConfig::FilesystemConfig(const libconfig::Setting& settings) {
    ...
    system_info_cfg = settings[SYSTEM_INFO_GROUP.c_str()];
#ifdef FORCE_CONFIG
