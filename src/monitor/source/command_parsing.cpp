...
monitor::parse_command(const std::string &cmd_line) noexcept {
...
std::vector<std::string> monitor::split(const std::string &str,
...
monitor::make_opt(const std::string &opt_token) noexcept {
...
monitor::name_params(const std::vector<std::string> &arg_tokens) noexcept {
...
nlohmann::json
monitor::make_opt_obj(const std::vector<std::string> &opt_tokens) noexcept {
